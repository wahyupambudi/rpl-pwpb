    ...
    <div class="container">
      ...
      <form action="register.php" method="POST">
        ...
        <div class="mb-3">
          ...
          <input type="notelp" class="form-control" id="notelp" placeholder="notelp" name="notelp" required>
        </div>
        <div class="mb-3">
          <label for="password" class="form-label">Password</label>
          <input type="password" class="form-control" id="password" placeholder="password" name="password" required>
        </div>
        <input type="submit" value="Daftar Akun" class="btn btn-block btn-primary">
